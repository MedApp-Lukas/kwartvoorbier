...
// UI Components (de "domme" bouwstenen)
import Header from './components/Header';
import Countdown from './components/Countdown';

// Feature Components (de "slimme" onderdelen)
import OrderForm from './features/orders/OrderForm';
import ClosedMessage from './features/orders/ClosedMessage';
import OrderList from './features/orders/OrderList';

// Page Components (de complete schermen)
import AdminPage from './pages/AdminPage';

// Types & Constants
import { AppState, ViewMode } from './types/index';
import type { Order, Product, Location } from './types/index';
